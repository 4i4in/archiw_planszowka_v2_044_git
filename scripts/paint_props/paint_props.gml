function paint_props(_xx,_yy,_prop_string)
{
	...
	var _id_props_xy = game_board_array[_xx][_yy][$ "tile_props"];
	var _iterations_found = 0;
	var _values_found = 0;
	...
	_values_found += mapeditor.terrain_paint_sign;
	if _values_found > 0
		{
