...
function editor_step9()
{
	...
	ds_list_add(clickable_list,"_256x64_background");//picture
	ds_list_add(clickable_list,"list of generators to apply on map");//txt mouseover rclick in case of "_"
	...
	ds_list_add(clickable_list,xxx	+	xref*game_struct.button_size	+ 2*game_struct.button_size);//x2
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size	+game_struct.button_size);//y2	
	ds_list_add(clickable_list,"Conect cities \n to metropoly");//txt
	ds_list_add(clickable_list,"_128x64_background");//picture
	ds_list_add(clickable_list,"conecting cities by \n tile to tile");//txt mouseover rclick in case of "_"
	ds_list_add(clickable_list,"exe_clickable_generator_conect_cities");	//execution on click	
	ds_list_add(clickable_list,"_");	//execution on right click
	xref += 2;
	ds_list_add(clickable_list,xxx	+	xref*game_struct.button_size);//x1
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size);//y1
	ds_list_add(clickable_list,xxx	+	xref*game_struct.button_size	+ 2*game_struct.button_size);//x2
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size	+game_struct.button_size);//y2	
	ds_list_add(clickable_list,"Create side map \n for visibility");//txt
	ds_list_add(clickable_list,"_128x64_background");//picture
	ds_list_add(clickable_list,"creating visibility \n for each side");//txt mouseover rclick in case of "_"
	ds_list_add(clickable_list,"exe_clickable_generator_side_operational_map");	//execution on click	
	ds_list_add(clickable_list,"_");	//execution on right click
	
	
	
	//gameplay function test buttons
	yref ++;
	xref = 0;
	ds_list_add(clickable_list,xxx	+	xref*game_struct.button_size);//x1
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size);//y1
