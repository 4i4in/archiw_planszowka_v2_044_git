function paint_city(_xx,_yy,_side)
{
			...
			if _terrain_is_legal = 1
				{
					...
					var _city_name_searching_for = "city_" +string(_side) + "_";
					...
					if _city_values_found > _terrain_legal_value
						{	
							...
							mo_string = string(_side) + " city size limit in this terrain is : " + string(_terrain_legal_value);
