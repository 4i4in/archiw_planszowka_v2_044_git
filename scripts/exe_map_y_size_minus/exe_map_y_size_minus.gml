//exe_map_y_size_minus
function exe_map_y_size_minus()
{
	if lclick_cooldown_counter < 1
		{
			game_struct.map_ysize -= mapeditor.map_size_step;
			if game_struct.map_ysize < mapeditor.map_y_min_size	{	game_struct.map_ysize = mapeditor.map_y_min_size	};
