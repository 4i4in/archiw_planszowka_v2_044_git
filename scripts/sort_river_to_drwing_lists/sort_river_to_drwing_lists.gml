function sort_river_to_drwing_lists(_array1,_xx,_yy,_tt)
{
	...
	for(var _ii = 0; _ii < _props_array_length; _ii++)
		{
			...
			ds_list_add(draw_rivers_map,xref);
			ds_list_add(draw_rivers_map,yref);
			ds_list_add(draw_rivers_map,_props_found);
		}
}