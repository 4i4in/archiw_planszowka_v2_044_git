function exe_uncover_underwater_visibility_for_tile(_ii,_xx,_yy,_val)
{
	...
	var _tile_worth_of_update = 0
		{
			...
			if _fog_ow_war[2] < _val	{_tile_worth_of_update = 2;};
		}
							...
							for(var _ee = 0; _ee < array_length(_str_units_groups); _ee++)
								{
									...
									if _group_control == _this_side
									...
									else
										{
											...
											var _you_see_shit = 0;
											if array_length(_temp_group) < 2	&&	_terrain_is_water = 1
												{
													var _unit_found = return_unknown_unit();
													array_push(_temp_group,_unit_found);
												}
											if array_length(_temp_group) < 2	&&	_terrain_is_water = 0
												{
													_you_see_shit = 1;
												}
											if _you_see_shit = 0
