function exe_check_if_road_is_continuos_from_to(source_x,source_y,_xx,_yy)
{
	var _road_is_continuos = 0;
	var _road_array_source = game_board_array[source_x][source_y][$ "road"];
	var _road_array_target = game_board_array[_xx][_yy][$ "road"];
			...
			for(var _ii = 0; _ii < array_length(_road_array_source);_ii++)
				{
					...
					_road_here = string_delete(_road_here,1,string_length("roads_"));
