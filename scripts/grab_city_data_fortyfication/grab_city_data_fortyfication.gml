function grab_city_data_fortyfication(_array1,_xx,_yy,_resources_total)
{
	//grabing resources
			...
			for(var _ii = 0; _ii < array_length(_check_this_array); _ii++)
				{
					...
					if string_starts_with(string(_this_resource),"fortyfication_")
						{
							...
							var _resource_minus_prefix = string_delete(_this_resource,1,string_length("fortyfication_"));
