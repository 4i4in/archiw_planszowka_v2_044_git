...
function editor_step3()
{
	...
	if string_length(_string_paint) > 1	{_string_paint = "Resources" + "\n" + string_delete(_string_paint, 1, 6);}
	else	{_string_paint = "Resources";};
	ds_list_add(clickable_list,xxx	+	xref*game_struct.button_size);//x1
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size);//y1
	ds_list_add(clickable_list,xxx	+	xref*game_struct.button_size	+ 4*game_struct.button_size);//x2
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size	+game_struct.button_size);//y2	
	...
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size	+game_struct.button_size);//y2	
	ds_list_add(clickable_list,"");//txt
	ds_list_add(clickable_list,"_64x64_animals_0");//picture
	ds_list_add(clickable_list,"left click \n to paint animals");//txt mouseover rclick in case of "_"
	ds_list_add(clickable_list,"exe_terrain_paint_animals");	//execution on click	
	ds_list_add(clickable_list,"_");	//execution on right click
	xref ++;
	ds_list_add(clickable_list,xxx	+	xref*game_struct.button_size);//x1
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size);//y1
	...
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size	+game_struct.button_size);//y2	
	ds_list_add(clickable_list,"");//txt
	ds_list_add(clickable_list,"_64x64_coal_0");//picture
	ds_list_add(clickable_list,"left click \n to paint coal");//txt mouseover rclick in case of "_"
	ds_list_add(clickable_list,"exe_terrain_paint_coal");	//execution on click	
	ds_list_add(clickable_list,"_");	//execution on right click
	xref ++;	
	ds_list_add(clickable_list,xxx	+	xref*game_struct.button_size);//x1
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size);//y1
	...
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size	+game_struct.button_size);//y2	
	ds_list_add(clickable_list,"");//txt
	ds_list_add(clickable_list,"_64x64_crops_0");//picture
	ds_list_add(clickable_list,"left click \n to paint crops");//txt mouseover rclick in case of "_"
	ds_list_add(clickable_list,"exe_terrain_paint_crops");	//execution on click	
	ds_list_add(clickable_list,"_");	//execution on right click
	xref ++;
	ds_list_add(clickable_list,xxx	+	xref*game_struct.button_size);//x1
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size);//y1
	...
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size	+game_struct.button_size);//y2	
	ds_list_add(clickable_list,"");//txt
	ds_list_add(clickable_list,"_64x64_gems_0");//picture
	ds_list_add(clickable_list,"left click \n to paint gems");//txt mouseover rclick in case of "_"
	ds_list_add(clickable_list,"exe_terrain_paint_gems");	//execution on click	
	ds_list_add(clickable_list,"_");	//execution on right click
	...
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size	+game_struct.button_size);//y2	
	ds_list_add(clickable_list,"");//txt
	ds_list_add(clickable_list,"_64x64_granite_0");//picture
	ds_list_add(clickable_list,"left click \n to paint granite");//txt mouseover rclick in case of "_"
	ds_list_add(clickable_list,"exe_terrain_paint_granite");	//execution on click	
	ds_list_add(clickable_list,"_");	//execution on right click
	xref ++;
	ds_list_add(clickable_list,xxx	+	xref*game_struct.button_size);//x1
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size);//y1
	...
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size	+game_struct.button_size);//y2	
	ds_list_add(clickable_list,"");//txt
	ds_list_add(clickable_list,"_64x64_iron_0");//picture
	ds_list_add(clickable_list,"left click \n to paint iron");//txt mouseover rclick in case of "_"
	ds_list_add(clickable_list,"exe_terrain_paint_iron");	//execution on click	
	ds_list_add(clickable_list,"_");	//execution on right click
	xref ++;	
	ds_list_add(clickable_list,xxx	+	xref*game_struct.button_size);//x1
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size);//y1
	...
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size	+game_struct.button_size);//y2	
	ds_list_add(clickable_list,"");//txt
	ds_list_add(clickable_list,"_64x64_marble_0");//picture
	ds_list_add(clickable_list,"left click \n to paint marble");//txt mouseover rclick in case of "_"
	ds_list_add(clickable_list,"exe_terrain_paint_marble");	//execution on click	
	ds_list_add(clickable_list,"_");	//execution on right click
	xref ++;
	ds_list_add(clickable_list,xxx	+	xref*game_struct.button_size);//x1
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size);//y1
	...
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size	+game_struct.button_size);//y2	
	ds_list_add(clickable_list,"");//txt
	ds_list_add(clickable_list,"_64x64_precious_metals_0");//picture
	ds_list_add(clickable_list,"left click \n to paint precious metals");//txt mouseover rclick in case of "_"
	ds_list_add(clickable_list,"exe_terrain_paint_precious_metals");	//execution on click	
	ds_list_add(clickable_list,"_");	//execution on right click
	
	//resoruces paints row 3
	yref ++;
	xref = 0;
	ds_list_add(clickable_list,xxx	+	xref*game_struct.button_size);//x1
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size);//y1
	...
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size	+game_struct.button_size);//y2	
	ds_list_add(clickable_list,"");//txt
	ds_list_add(clickable_list,"_64x64_rare_metals_0");//picture
	ds_list_add(clickable_list,"left click \n to rare metals");//txt mouseover rclick in case of "_"
	ds_list_add(clickable_list,"exe_terrain_paint_rare_metals");	//execution on click	
	ds_list_add(clickable_list,"_");	//execution on right click
	xref ++;
	ds_list_add(clickable_list,xxx	+	xref*game_struct.button_size);//x1
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size);//y1
	...
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size	+game_struct.button_size);//y2	
	ds_list_add(clickable_list,"");//txt
	ds_list_add(clickable_list,"_64x64_salt_0");//picture
	ds_list_add(clickable_list,"left click \n to paint salt");//txt mouseover rclick in case of "_"
	ds_list_add(clickable_list,"exe_terrain_paint_salt");	//execution on click	
	ds_list_add(clickable_list,"_");	//execution on right click
	xref ++;	
	ds_list_add(clickable_list,xxx	+	xref*game_struct.button_size);//x1
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size);//y1
	...
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size	+game_struct.button_size);//y2	
	ds_list_add(clickable_list,"");//txt
	ds_list_add(clickable_list,"_64x64_stones_0");//picture
	ds_list_add(clickable_list,"left click \n to paint stones");//txt mouseover rclick in case of "_"
	ds_list_add(clickable_list,"exe_terrain_paint_stones");	//execution on click	
	ds_list_add(clickable_list,"_");	//execution on right click
	xref ++;
	ds_list_add(clickable_list,xxx	+	xref*game_struct.button_size);//x1
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size);//y1
	...
	ds_list_add(clickable_list,yyy	+	yref*game_struct.button_size	+game_struct.button_size);//y2	
	ds_list_add(clickable_list,"");//txt
	ds_list_add(clickable_list,"_64x64_water_0");//picture
	ds_list_add(clickable_list,"left click \n to paint precious water");//txt mouseover rclick in case of "_"
	ds_list_add(clickable_list,"exe_terrain_paint_water");	//execution on click	
	ds_list_add(clickable_list,"_");	//execution on right click
