	...
	var _side_struct =
		{
			...
			max_units_on_tile : 8,
			max_AP_saving : 2,
			city_legal : ["m1","h4","p9","s3"],
			fortyfications_legal : ["m3","h5","p9","s7"],
			utylity : [ "utylity_human_agriculture","utylity_human_armory","utylity_human_artist","utylity_human_market",
						"utylity_human_mine","utylity_human_shipyard","utylity_human_shrine","utylity_human_smith",
						"utylity_human_stables","utylity_human_temple","utylity_human_tronroom","utylity_human_watchtower",
						"utylity_human_wizard"],
			...
			ruins : ["ruins_human_city", "ruins_human_sculpture","ruins_human_fortyfication","ruins_human_shrine",
					"ruins_human_watchtower","ruins_human_temple","ruins_human_mine"],
			
			consumption : ["city_human_eat_food",-1,"city_human_eat_water",-1],
			stayhome_production : ["stayhome_human_prop_forest_lumber",0.2,"stayhome_human_prop_wood_lumber",0.3],
			
			
			mining : ["utylity_human_mine",2],
			...
			lumberjack : ["utylity_human_lumberjack",1.5,"city_human_lumberjack",0.1],
			...
			visibility_granted : ["river","road","tile_props_forest","tile_props_wood","tile_props_swamps",
									"tile_props_vulcano"],
			visibility_multipler : ["mountains",3,"hills",2,"zhallow_water",1.3,"utylity_human_watchtower",2],
			foregin_policy :	[	["always_attack",],["oportunity_attack",],
									["oportunity_support",],["always_support","human",],
									["alllow_embarking","human",],
								],
			avilable_units : [
								["ship","human_ship1",				//recognition used only for painting on map, to generate name
								//those two above MUST exist on 0 an 1 position in array, rest must only have coherent lines "something", value
								"picture", "unit_human_ship1",	//picture
								"control", ["human",1],						//who control - by default own side
						...
						//================
								["merchant",	"human_merchant",	//recognition used only for painting on map, to generate name
								"picture", "population_human_merchant",	//picture
								"control", ["human",1],						//who control - by default own side
								"visibility", [-10,-10],						//negative is more visible
								...
								"base_values",	["place_taken",1,"hitpoints",1,"detection_value", [7,5,0],"visibility",-10,"carry_max",8,	
												],
							],
					//================
							["militia",	"human_militia",	//recognition used only for painting on map, to generate name
								"picture", "population_human_militia",	//picture
								"control", ["human",1],						//who control - by default own side
					...
					//================
							["peasants",	"human_peasants",	//recognition used only for painting on map, to generate name
								"picture", "population_human_peasants",	//picture
								"control", ["human",1],						//who control - by default own side
								"visibility", [-3,-3],						//negative is more visible
								"detection_value", [7,5,0],					//how unit see terrain
								"action_points", [10,10],					//action points max, current 
					...
					//================
							["miner",	"human_miner",	//recognition used only for painting on map, to generate name
								"picture", "population_human_miner",	//picture
								"control", ["human",1],						//who control - by default own side
								"visibility", [-3,-3],						//negative is more visible
								"detection_value", [7,5,0],					//how unit see terrain
								"action_points", [10,10],					//action points max, current 
					...
					//================
							["sheppards",	"human_sheppards",	//recognition used only for painting on map, to generate name
								"picture", "population_human_sheppards",	//picture
								"control", ["human",1],						//who control - by default own side
								"visibility", [-3,-3],						//negative is more visible
								"detection_value", [7,5,0],					//how unit see terrain
								"action_points", [10,10],					//action points max, current 
					...
					//================
							["townsfolk",	"human_townsfolk",	//recognition used only for painting on map, to generate name
								"picture", "population_human_townsfolk",	//picture
								"control", ["human",1],						//who control - by default own side
								"visibility", [-3,-3],						//negative is more visible
								"detection_value", [7,5,0],					//how unit see terrain
								"action_points", [10,10],					//action points max, current 
					...
					//================
							["seamen",	"human_seamen",	//recognition used only for painting on map, to generate name
								"picture", "population_human_seamen",	//picture
								"control", ["human",1],						//who control - by default own side
								"visibility", [-3,-3],						//negative is more visible
								"detection_value", [7,5,0],					//how unit see terrain
								"action_points", [10,10],					//action points max, current 
					...
					//================
							["wild",	"human_wild",	//recognition used only for painting on map, to generate name
								"picture", "population_human_wild",	//picture
								"control", ["human",1],						//who control - by default own side
								"visibility", [-3,-3],						//negative is more visible
								"detection_value", [7,5,0],					//how unit see terrain
								"action_points", [10,10],					//action points max, current 
								"hitpoints", [10,10],						//hit points max, current 
								"number", [30,30],						//number of them max, current 
								"carry_transport", ["carry_max",100],		//transportation ability 
								"active_buffs", ["attack",-1,"move",-1,"curious",-1,"embark_overwater",-1,],							//active buffs
								"buff_list", ["attack",-1,"move",-1,"curious",-1,"embark_overwater",-1,],							//buff list
								"legal_terrains",["mountains","hills","plain","sand","ship"],	//legal_terrains to place units
